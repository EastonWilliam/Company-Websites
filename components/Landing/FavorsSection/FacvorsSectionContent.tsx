		...
		<>
			...
			<div className="container mx-auto px-4">
				<div className="relative w-full text-center">
					...
					>
						How do we came with <span className="text-primary">favors?</span>
					</h1>
				</div>
			</div>

			{/* GRID + GRADIENT LINES WRAPPER */}
			<div className="container mx-auto px-4 relative">
				{/* GRADIENT LINES ONLY ON MD+ */}
				<div className="hidden md:block absolute inset-0 pointer-events-none z-10">
					{/* Vertical Line 1 */}
					<div
						className="absolute top-0 bottom-0 left-1/3 w-[3px] 
            bg-gradient-to-b from-transparent via-primary to-transparent"
					/>

					{/* Vertical Line 2 */}
					<div
						className="absolute top-0 bottom-0 left-2/3 w-[3px] 
            bg-gradient-to-b from-transparent via-primary to-transparent"
					/>

					{/* Horizontal Line */}
					<div
						className="absolute left-0 right-0 top-[calc(50%+10px)] h-[3px]
